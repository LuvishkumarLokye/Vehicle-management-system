...
Here is a LinkedIn post you can use:

```text
I built a Vehicle Management System using Django, Django REST Framework, SQLite, WeasyPrint, and Flet.

The system helps a vehicle service center manage customers, vehicles, repairs, oil-change schedules, appointments, and PDF invoices.
...
- PDF invoice generation with latest repair records
- REST API endpoints for vehicles, repairs, oil changes, and appointments
- A Flet client app that consumes the Django API

This project helped me practice full-stack backend development, API design, validation logic, PDF generation, and connecting a Python frontend client to a Django backend.

Tech stack:
Django | Django REST Framework | SQLite | WeasyPrint | Flet | Python

#Python #Django #DjangoRESTFramework #Flet #WebDevelopment #APIDevelopment #SoftwareDevelopment #PortfolioProject
```

Shorter LinkedIn version:

```text
I created a Vehicle Management System with Django and Django REST Framework, plus a Flet app that consumes the API.

It manages vehicles, customers, repairs, oil changes, appointments, and PDF invoices with amounts in Rs.

This project gave me hands-on experience with API development, business logic validation, PDF generation, and integrating a Python client app with a Django backend.

#Python #Django #Flet #DjangoRESTFramework #APIDevelopment #PortfolioProject
```
